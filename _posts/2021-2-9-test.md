...
For a ==right triangle== with leg lengths a, b and hypotenuse length c,
$$
\begin{equation}
a^2 + b^2 = c^2\tag{1}\label{eq:eqn1}
\end{equation}
$$
$$
\text{From} \eqref{eq:eqn1} \text{we know:}
\begin{equation}
\sin(x)^2+\cos(x)^2=1^2\tag{2}\label{eq:eqn2}
\end{equation}
$$
